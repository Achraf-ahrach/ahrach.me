          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="mockup-float mockup-shadow">
                <Image src="/yobarber/hero.png" alt="YoBarber app preview" width={540} height={700} className="w-[320px] sm:w-[400px] lg:w-[480px] xl:w-[540px] h-auto" style={{ height: "auto" }} priority />
              </div>
            </div>
          </div>
          {/* Scroll indicator */}
